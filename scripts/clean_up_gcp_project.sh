...
# 1. Navigate "IAM & Admin" > "Service Accounts" for the GCP Project you want to delete.
# 2. Click on one and choose "Edit", then "+ Create Key" to create a "JSON" key. This will
...
if [[ $REPLY =~ ^[Yy]$ ]]
then
  echo "\nStarting to clean up GCP resources ..."
