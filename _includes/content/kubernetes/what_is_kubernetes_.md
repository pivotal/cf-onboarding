...
🤓 If you are interested in learning even more about kubernetes, check out these [Kubernetes Learning Week stories](https://github.com/pivotal/kubernetes-learning-week-syllabus/tree/master/modules).

🐞 These stories are intended to give engineers a deep-dive into k8s concepts, resources, and tooling.

➕ To add these stories to this tracker: clone the [repo](https://github.com/pivotal/kubernetes-learning-week-syllabus), run the build script, and then import the created CSV to your tracker.
